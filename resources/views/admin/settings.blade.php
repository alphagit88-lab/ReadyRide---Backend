  ...
  <div style="max-width: 720px;">
    ...
    <div class="card" style="margin-bottom: 24px;">
      <div class="card-header">
        ...
        <div style="flex:1;">
          <div class="card-title">Android App Version</div>
          <div style="font-size:12px;color:var(--text2);margin-top:2px;">Used to process mobile app force update.</div>
        </div>
      </div>
      <div style="padding:24px;">
        <form method="POST" action="{{ route('admin.settings.update') }}">
          @csrf
          @method('PUT')
          <input type="hidden" name="key" value="android_app_version" />
          <div class="form-group full" style="margin-bottom:20px;">
            <label for="android_app_version_value">Version</label>
            <input type="text" id="android_app_version_value" name="value" 
              placeholder="1.0.0" 
              value="{{ old('value', $android_app_version ?? '') }}"
